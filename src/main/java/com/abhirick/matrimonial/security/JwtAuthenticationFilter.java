...
import com.abhirick.matrimonial.model.LoginViewModel;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	/*
	 * Trigger when we issue POST request to /login We also need to pass in {"username":"dan", "password":"dan123"} in the request body
	 */
	@Override
